...
- 提案する料理(元の料理または置き換え後の料理)に関連した、意外性のある豆知識を1つ、
  3択クイズの形で作る(質問文・選択肢3つ・その中の正解を1つ)。栄養素の話に偏らせず、
  食材の歴史・地域による違い・調理科学(なぜその工夫で美味しくなるか)・食文化・
  紛らわしい雑学など、ジャンルは広く取ってよい。「聞いたことがある当たり前の話」ではなく、
  「え、知らなかった」と思えるレベルの意外性を優先する
